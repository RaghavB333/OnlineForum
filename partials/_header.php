        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-flex mx-2">
                <form class="d-flex" role="search" action="search.php" method="get">
                    <input class="form-control me-2 my-3" name="search" type="search" placeholder="Search" aria-label="Search" style="height: 35px;">
...
<!-- // SQL query to get categories
                    ...
                    // // Loop to fetch categories and create dropdown items
                    // while ($row = mysqli_fetch_array($result)) {
                    //     echo '<li class="dropdown-item" href="threadlist.php?catid=' . $row['category_id'] . '">' . $row['category_name'] . '</li>';
                    // }
                     -->